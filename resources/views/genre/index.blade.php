        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                            ...
                            <div class="row">
                                <div class="col-lg-6 hr ">
                                    <div class="form-row hf">
                                        <div class="create">
                                            <a  href="{{route('genre.create')}}" class="btn btn-primary mb-5 "> <i class="fa fa-plus" ></i> Thêm mới thể loại</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                    @foreach( $genre as $index => $gen)
                        <tr>
                            <td class="text-center"> {{ $loop->iteration }}</td>
                            <td class="text-center">{{$gen->name}}</td>
                            <td class="text-center ">
                                <a href="{{route('genre.edit',$gen->id)}}" class=" btn btn-success btnedit "><i class="fa fa-edit"></i></a>
                            </td>
